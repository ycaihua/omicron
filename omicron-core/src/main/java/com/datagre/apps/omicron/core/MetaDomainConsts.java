package com.datagre.apps.omicron.core;

import com.datagre.apps.omicron.core.enums.Env;
import com.datagre.apps.omicron.core.utils.ResourceUtils;
 ...
 * from omicron-env.properties. If neither exists, will load the default meta url.
 * 
 * Currently, omicron supports local/dev/fat/uat/lpt/pro environments.
 */
public class MetaDomainConsts {
  ...
  static {
    ...
    prop = ResourceUtils.readConfigFile("omicron-env.properties", prop);

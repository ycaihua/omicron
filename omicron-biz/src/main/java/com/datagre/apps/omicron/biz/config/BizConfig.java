package com.datagre.apps.omicron.biz.config;

import com.datagre.apps.omicron.biz.service.BizDBPropertySource;
import com.datagre.apps.omicron.common.config.RefreshableConfig;

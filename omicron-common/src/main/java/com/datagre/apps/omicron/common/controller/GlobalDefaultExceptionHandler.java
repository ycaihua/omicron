...
import com.datagre.apps.omicron.common.exception.AbstractOmicronHttpException;
...
public class GlobalDefaultExceptionHandler {
  ...
  //处理自定义Exception
  @ExceptionHandler({AbstractOmicronHttpException.class})
  public ResponseEntity<Map<String, Object>> badRequest(HttpServletRequest request, AbstractOmicronHttpException ex) {
    return handleError(request, ex);
  }


  private ResponseEntity<Map<String, Object>> handleError(HttpServletRequest request,
                                                          AbstractOmicronHttpException ex) {

 ...
 */
package com.datagre.apps.omicron.client.util.function;
import com.datagre.apps.omicron.client.exceptions.OmicronConfigException;
import com.datagre.apps.omicron.client.util.parser.ParserException;
    ...
    Function<String, Date> TO_DATE_FUNCTION = new Function<String, Date>() {
        ...
        public Date apply(String input) {
            try {
                ...
                throw new OmicronConfigException("Parse date failed", ex);
            }
        }
    };
    Function<String, Long> TO_DURATION_FUNCTION = new Function<String, Long>() {
        ...
        public Long apply(String input) {
            try {
                ...
                throw new OmicronConfigException("Parse duration failed", ex);
            }
        }
    };
}

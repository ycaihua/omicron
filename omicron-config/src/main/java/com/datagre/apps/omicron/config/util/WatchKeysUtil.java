 ...
 */
package com.datagre.apps.omicron.config.util;

import com.datagre.apps.omicron.common.entity.AppNamespace;
import com.datagre.apps.omicron.config.service.AppNamespaceCacheService;
...
public class WatchKeysUtil {
    ...
    @Autowired
    private AppNamespaceCacheService appNamespaceService;
